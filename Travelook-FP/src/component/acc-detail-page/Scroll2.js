...
const Scroll2 = (props) => {  //* props ini parameter const scroll,..yang mengacu pada property komponen scroll nantinya di app.js
    ...
    return (
        <div style = {{ overflow: 'scroll', border: '2px solid #C4C4C4', height: '650px', width: '800px', overflowX: "hidden"}}>  {/**penulisan css pada jsx secara inline yaitu style {{}} */}
